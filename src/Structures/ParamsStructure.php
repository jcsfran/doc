...
class ParamsStructure
{
    ...
    public function headerPaginate(array $params): string
    {
        ...
        $structure .= str_repeat(config('documentation.space'), 8) . "- in: query" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) . 'name: page' . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) . "schema:" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 12) . "type: integer" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) . "required: false" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) .
            "description: Número da página" .
            PHP_EOL;

        $structure .= str_repeat(config('documentation.space'), 8) . "- in: query" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) . 'name: limit' . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) . "schema:" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 12) . "type: integer" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) . "required: false" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) .
        ...
        $structure .= str_repeat(config('documentation.space'), 8) . "- in: query" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) . 'name: sort' . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) . "schema:" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 12) . "type: string" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) . "required: false" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) .
        ...
        $structure .= str_repeat(config('documentation.space'), 8) . "- in: query" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) . 'name: order' . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) . "schema:" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 12) . "type: string" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 12) . "enum:" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 14) . "- asc" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 14) . "- desc" . PHP_EOL;
        $structure .= str_repeat(config('documentation.space'), 10) .
